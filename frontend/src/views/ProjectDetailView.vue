    ...
    <div v-else-if="project" class="space-y-6">
          ...
          <Card class="border border-surface-200">
            <template #content>
              <div v-if="!editing" class="space-y-4">
                ...
                <div>
                  <label class="block text-sm font-medium text-surface-400 mb-1"
                    >Project Name</label
                  >
          ...
          <Card class="border border-surface-200">
            <template #content>
              <div class="flex flex-col items-center text-center py-8 gap-4">
                ...
                <p class="text-surface-500 max-w-lg">
          ...
          <Card class="border border-surface-200">
            <template #content>
              <div class="flex flex-col items-center text-center py-8 gap-4">
                ...
                <p class="text-surface-500 max-w-lg">
                  View sprints and backlog items with filtering. Manage sprint planning, reviews,
                  and retrospectives.
                </p>
      ...
      >
        <form @submit.prevent="addMember" class="space-y-4">
          ...
          <div class="space-y-1.5">
            <label for="userEmail" class="block text-sm font-medium text-surface-700"
              >User Email *</label
            >
            <InputText
              id="userEmail"
